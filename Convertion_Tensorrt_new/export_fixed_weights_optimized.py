...
This version includes memory optimizations to prevent OOM during export.
"""
    ...
    try:
        ...
        if dino_missing:
            ...
            try:
                ...
                del dinov2_model, official_weights
                gc.collect()
...
def export_onnx(
    ...
    # Add external data format if available (helps with memory)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Export MatchAnything to ONNX (memory-optimized version)")
    parser.add_argument("--onnx", default="output/matchanything_fixed_weights_optimized.onnx", 
