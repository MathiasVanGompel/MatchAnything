...
def check_roma_installation():
    ...
    roma_root = os.path.join(os.path.dirname(current_dir), "imcui", "third_party", "MatchAnything", "third_party", "ROMA")
...
def print_installation_instructions():
    ...
    print("   pip install tensorrt pycuda onnx-graphsurgeon  # Optional but recommended")
...
def main():
    ...
    if python_ok and cuda_ok and tensorrt_ok and packages_ok and roma_ok:
        ...
        print("\nNext steps:")
        print("1. Run: ./build_tensorrt.sh --help")
        print("2. Convert your model: ./build_tensorrt.sh --ckpt /path/to/checkpoint.ckpt")
    else:
