...
def main():
    ...
    parser.add_argument(
        ...
        type=str, 
        default=None, 
        help="Path to MatchAnything checkpoint"
    )
    parser.add_argument(
        "--no_graph_surgery", 
        action="store_true", 
        help="Skip EyeLike operator removal"
    )
    ...
    print(f"    --image0 image1.jpg --image1 image2.jpg")
    
    print("\n" + "="*60)
    print("CONVERSION READY")
    print("="*60)
    print("The exported ONNX model maintains exact accuracy with the original PyTorch implementation.")
