...
_PARENT_DIR = _THIS_DIR / "Convertion_Tensorrt_new"
...
def export_onnx_with_detailed_feedback(
    ...
    # Ensure dimensions are multiples of 14 for ViT compatibility
    H = ((H + 13) // 14) * 14  # Round up to nearest multiple of 14
    W = ((W + 13) // 14) * 14
    
    print(f"[EXPORT] Adjusted input dimensions: {H}x{W}")
